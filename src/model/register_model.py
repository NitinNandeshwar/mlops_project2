...
def register_model_and_transformer(model_name: str, model_info: dict, transformer_name: str, transformer_path: str):
    """Register the model and data transformer to the MLflow Model Registry."""
    try:
        ...
        # Transition the DataTransformer to "Staging"
        client.transition_model_version_stage(
            name=transformer_name,
            version=transformer_version.version,
            stage="Staging"
        )
        logging.debug(f'DataTransformer {transformer_name} version {transformer_version.version} registered and transitioned to Staging.')
...
def main():
    try:
        ...
        model_name = "my_model"
        transformer_name = "data_transformer"
        transformer_path = "models/data_transformer.pkl"  # Ensure this file exists
